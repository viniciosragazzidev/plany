...
import { studyBenches, profiles, subjects, materials } from "@/lib/db/schema";
  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      <header className="h-16 border-b border-border/50 px-6 flex items-center justify-between bg-background/80 backdrop-blur-md z-20 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
             ...
             <h2 className="text-sm font-bold tracking-tight text-foreground truncate max-w-[200px] md:max-w-md">
                {bench.goalName}
             </h2>
          </div>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left Column: Sources */}
        <SourceColumn materials={benchMaterials as any} />
