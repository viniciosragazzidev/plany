...
export function SummariesTool({ benchId, subjects, materials }: SummariesToolProps) {
  ...
  return (
    <>
      ...
      >
        <DialogContent className="max-w-none min-w-[85vw] w-screen h-[95vh] flex flex-col p-0 gap-0 overflow-hidden border-none shadow-none rounded-3xl outline-none bg-background/98 backdrop-blur-xl">
          ...
          <div className="flex-1 flex overflow-hidden">
            <ScrollArea className="flex-1">
              <div className="w-full max-w-[1200px] mx-auto py-16 px-8 lg:px-16 space-y-20 relative">
                ...
                {activeSummaryData?.timeline.map((step: any, idx: number) => (
                  <div key={idx} className="relative pl-20 lg:pl-28 group animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-both" style={{ animationDelay: `${idx * 150}ms` }}>
                    <div className="absolute left-0 lg:left-4 top-0 w-12 h-12 rounded-2xl bg-background border-2 border-emerald-500 shadow-lg shadow-emerald-500/10 flex items-center justify-center text-emerald-600 text-lg font-black group-hover:bg-emerald-500 group-hover:text-white group-hover:scale-110 transition-all z-10">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        {step.analogy && (
                          <div className="group/card relative p-6 rounded-[2rem] bg-amber-50/20 border border-amber-200/40 transition-all hover:bg-amber-50/50 hover:shadow-xl hover:shadow-amber-500/5 overflow-hidden">
                            <div className="absolute right-0 top-0 p-4 text-amber-500/5 rotate-12 group-hover/card:rotate-0 transition-transform">
                              <HugeiconsIcon icon={Idea01Icon} size={80} />
                            </div>
                            <div className="space-y-4 relative z-10">
                              ...
                              <p className="text-sm text-amber-900 leading-relaxed font-bold italic">
                                "{step.analogy}"
                              </p>
                            </div>
                          </div>
                        ...
                        {step.masterTip && (
                          <div className="group/card relative p-6 rounded-[2rem] bg-emerald-50/20 border border-emerald-200/40 transition-all hover:bg-emerald-50/50 hover:shadow-xl hover:shadow-emerald-500/5 overflow-hidden">
                            <div className="absolute right-0 top-0 p-4 text-emerald-500/5 -rotate-12 group-hover/card:rotate-0 transition-transform">
                              <HugeiconsIcon icon={StarsIcon} size={80} />
                            </div>
                            <div className="space-y-4 relative z-10">
                      ...
                      <div className="flex items-center gap-4 pt-2">
                        <Button 
                          className="h-10 px-6 rounded-xl gap-2 text-[11px] font-black uppercase tracking-wider bg-emerald-500 text-white shadow-md shadow-emerald-500/10 hover:scale-105 transition-all"
                        >
                        ...
                        <Button 
                          ...
                          className="h-10 px-4 rounded-xl gap-2 text-[11px] font-bold text-muted-foreground hover:text-emerald-600 hover:bg-emerald-50 transition-all border border-border/50"
                        >
                ...
                <div className="pt-24 pb-20 text-center space-y-8">
                   <div className="relative inline-block">
                     ...
                     <div className="relative w-20 h-20 bg-emerald-500 shadow-xl shadow-emerald-500/20 rounded-[2rem] flex items-center justify-center mx-auto text-white">
                        <HugeiconsIcon icon={StarsIcon} size={32} />
                     </div>
                   </div>
                   <div className="space-y-3">
                     <h5 className="text-3xl font-black text-foreground tracking-tight leading-none">Mapa Completo!</h5>
                     <p className="text-lg text-muted-foreground italic max-w-2xl mx-auto px-8 leading-relaxed font-medium">
                   ...
                   <Button 
                    size="lg"
                    onClick={() => setSidebarState('summary_list')}
                    className="rounded-2xl h-12 px-10 text-xs font-black uppercase tracking-widest bg-foreground text-background hover:bg-emerald-600 transition-all"
                   >
