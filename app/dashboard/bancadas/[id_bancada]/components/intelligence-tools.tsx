    ...
    <div className="flex flex-col h-full bg-secondary/5 border-l border-border/50 w-72 shrink-0 font-sans">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="space-y-3">
          <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest ml-1">IA Insights</p>
          <div className="grid grid-cols-2 gap-2">
            <Button variant="outline" className="h-auto py-4 flex-col gap-2 rounded-2xl bg-background border-border/50 hover:border-primary/50 transition-all">
              ...
              <span className="text-xs font-bold">Gerar Quiz</span>
            </Button>
            <Button variant="outline" className="h-auto py-4 flex-col gap-2 rounded-2xl bg-background border-border/50 hover:border-primary/50 transition-all">
            ...
            <Button variant="outline" className="h-auto py-4 flex-col gap-2 rounded-2xl bg-background border-border/50 hover:border-primary/50 transition-all col-span-2">
              ...
              <span className="text-xs font-bold">Resumo Estruturado</span>
            </Button>
          </div>
        </div>
        ...
        {/* Progress & Stats */}
        <div className="space-y-3">
          <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest ml-1">Seu Progresso</p>
          <Card className="p-4 rounded-2xl border-border/50 bg-background space-y-4">
            <div className="flex justify-between items-center">
               <div className="flex items-center gap-2">
                 ...
                 <span className="text-sm font-bold">Contagem Regressiva</span>
               </div>
               <span className="text-sm font-bold text-primary">{daysLeft} dias</span>
            </div>
        ...
        <div className="mt-auto">
          <Card className="p-4 rounded-2xl border-primary/20 bg-primary/5 space-y-3 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className="text-sm font-bold">Dica de Bem-estar</span>
            </div>
